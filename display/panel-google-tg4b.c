...
/*
 * MIPI-DSI based tg4b AMOLED LCD panel driver.
 *
...
/**
 * struct tg4b_panel - panel specific runtime info
 *
 * This struct maintains tg4b panel specific runtime info, any fixed details about panel
...
#define to_spanel(ctx) container_of(ctx, struct tg4b_panel, base)

static const struct exynos_dsi_cmd tg4b_lp_cmds[] = {
...
static const struct exynos_dsi_cmd tg4b_off_cmds[] = {
...
static void tg4b_update_irc(struct exynos_panel *ctx,
...
static void tg4b_change_frequency(struct exynos_panel *ctx,
...
static void tg4b_set_nolp_mode(struct exynos_panel *ctx,
				  const struct exynos_panel_mode *pmode)
{
...
static void tg4b_dimming_frame_setting(struct exynos_panel *ctx, u8 dimming_frame)
{
	/* Fixed time 1 frame */
	if (!dimming_frame)
		dimming_frame = 0x01;
...
static int tg4b_enable(struct drm_panel *panel)
{
	...
	exynos_panel_send_cmd_set(ctx, &tg4b_init_cmd_set);
	tg4b_change_frequency(ctx, pmode);
...
static int tg4b_atomic_check(struct exynos_panel *ctx, struct drm_atomic_state *state)
{
...
static void tg4b_set_hbm_mode(struct exynos_panel *ctx,
...
static bool tg4b_is_mode_seamless(const struct exynos_panel *ctx,
				     const struct exynos_panel_mode *pmode)
{
...
static void tg4b_get_panel_rev(struct exynos_panel *ctx, u32 id)
{
...
static int tg4b_read_id(struct exynos_panel *ctx)
{
...
static const struct exynos_panel_mode tg4b_modes[] = {
	{
		.mode = {
			.name = "1080x2424x60",
			.clock = 167922,
...
static const struct exynos_panel_mode tg4b_lp_mode = {
	.mode = {
		.name = "1080x2424x30",
		.clock = 83961,
		.hdisplay = 1080,
...
static void tg4b_debugfs_init(struct drm_panel *panel, struct dentry *root)
{
	...
	exynos_panel_debugfs_create_cmdset(ctx, csroot, &tg4b_init_cmd_set, "init");
	dput(csroot);
panel_out:
	dput(panel_root);
}

static void tg4b_panel_init(struct exynos_panel *ctx)
{
	tg4b_dimming_frame_setting(ctx, TG4B_DIMMING_FRAME);
}
...
static int tg4b_panel_config(struct exynos_panel *ctx);

static const struct exynos_panel_funcs tg4b_exynos_funcs = {
...
static const struct exynos_brightness_configuration tg4b_btr_configs[] = {
	{
...
struct exynos_panel_desc google_tg4b = {
	.data_lane_cnt = 4,
	...
	.min_luminance = 5,
	.modes = tg4b_modes,
	.num_modes = ARRAY_SIZE(tg4b_modes),
	.off_cmd_set = &tg4b_off_cmd_set,
	.lp_mode = &tg4b_lp_mode,
	.lp_cmd_set = &tg4b_lp_cmd_set,
...
static int tg4b_panel_config(struct exynos_panel *ctx)
{
	...
	ret = exynos_panel_init_brightness(&google_tg4b,
						tg4b_btr_configs,
...
static const struct of_device_id exynos_panel_of_match[] = {
	{ .compatible = "google,tg4b", .data = &google_tg4b },
	{ }
};
